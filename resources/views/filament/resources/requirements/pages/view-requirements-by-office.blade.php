...
<style>
    ...
    :root {
        ...
        --gold-300:  #fbbf24;
        --gold-400:  #f59e0b;
        --gold-500:  #d97706;   /* primary action gold */
        --gold-600:  #b45309;   /* deep amber */
        --gold-700:  #92400e;   /* rich bronze */
        --gold-800:  #78350f;   /* dark bronze */
        --gold-900:  #451a03;   /* near-black bronze */

        --surface:   #ffffff;
        --surface-2: #fffbf2;   /* warm off-white tint */
        --border:    #fde68a;   /* gold-200 */
        --border-strong: #f59e0b; /* gold-400 */
        --text-primary:   #1c0a00;
